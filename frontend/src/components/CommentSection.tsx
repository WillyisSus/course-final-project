                          ...
                          <div className="flex-1 flex gap-3 p-3 bg-amber-50/60 border border-amber-100 rounded-lg">
                            ...
                            <div className="space-y-1">
                              <div className="flex items-center gap-2">
                                ...
                                <Badge
                                  variant="secondary"
                                  className="text-[10px] h-5 px-1.5 bg-amber-100 text-amber-700 border-amber-200 hover:bg-amber-100"
                                >
                                  Seller
                                </Badge>
                                <span className="text-xs text-gray-400">
      ...
      >
            ...
            <span className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <span className="truncate">
                ...
                <span className="font-bold">
                  {replyingTo.user.full_name}: {replyingTo.content}
                </span>
              </span>
            </span>
            <button
              onClick={() => setReplyingTo(null)}
              className="hover:bg-blue-100 p-1 rounded shrink-0"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
        ...
        <div className="flex flex-row gap-3 self-end">
          ...
          <Button
            ...
            disabled={!text.trim()}
            className={replyingTo ? "bg-amber-600 hover:bg-amber-700" : ""}
          >
