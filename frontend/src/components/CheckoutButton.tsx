...
const CheckoutButton = ({ amount, product_id, seller_id }: CheckoutButtonProps) => {
    const navigate = useNavigate();

    // Configuration for the PayPal SDK
    const initialOptions = {
        // REPLACE THIS with your actual Sandbox Client ID from developer.paypal.com
        clientId: "Abq0Ui9c09fNJmCsd6ksRKnyUdd-wzXV5Nt5ytnVjnwJEkjH8sug8wxWlLKjj6QNHhk37jXYJHoeFv6L", 
        currency: "USD",
        intent: "capture",
    };
    ...
    return (
        <PayPalScriptProvider options={initialOptions}>
            <div className="z-0 relative"> {/* z-0 fixes some overlay issues */}
                <PayPalButtons
