    ...
    <header className="sticky top-0 z-50 w-full border-b bg-white shadow-sm">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 flex-1">
          <Link
            to="/"
            className="text-2xl font-bold text-blue-600 flex items-center gap-2 hover:opacity-90 transition"
          >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="hidden md:flex gap-1 font-medium text-gray-700"
              >
                ...
                return (
                  <DropdownMenuItem key={category.category_id} asChild>
                    <Link
                      ...
                      className="cursor-pointer w-full block py-2"
                    >
                      {category.name}
                    </Link>
                  </DropdownMenuItem>
            ...
            <>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="flex items-center gap-2 px-2 hover:bg-blue-50"
                  >
