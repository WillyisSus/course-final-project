    ...
    return (
        <div className="container self-center maxpy-10">
            <div className="mb-8 space-y-2">
                ...
                <p className="text-muted-foreground">List your item for thousands of potential bidders.</p>
            </div>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="e.g. Vintage Gibson Les Paul" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                                                        ...
                                                        parent.sub_categories.length > 0 ? (
                                                            ...
                                                            <SelectGroup key={parent.category_id}>
                                                                ...
                                                                {parent.sub_categories.map((child: any) => (
                                                                    <SelectItem key={child.category_id} value={String(child.category_id)} className="pl-6">
                                                                        {child.name}
                                                                    </SelectItem>
                                                                ))}
                                                            </SelectGroup>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea className="min-h-[120px]" placeholder="Detailed description..." {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                    ...
                                    {previews.map((src, idx) => (
                                        <div key={idx} className="relative col-span-1 h-32 border rounded-lg overflow-hidden group">
                                            ...
                                            {idx === 0 && <div className="absolute bottom-0 w-full bg-primary text-primary-foreground text-[10px] text-center py-0.5">Primary</div>}
                                        </div>
                                    ))}
                                </div>
                            </div>
